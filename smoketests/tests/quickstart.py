...
class Rust(BaseQuickstart):
    ...
    client_doc = STDB_DIR / "docs/docs/07-Client SDL Languages/04-rust-quickstart.md"
...
class CSharp(BaseQuickstart):
    lang = "csharp"
    server_doc = STDB_DIR / "docs/docs/06-Server Module Languages/04-c-sharp-quickstart.md"
    client_doc = STDB_DIR / "docs/docs/sdks/07-Client SDL Languages/02-c-sharp-quickstart.md"
    server_file = "Lib.cs"
